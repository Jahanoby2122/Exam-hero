...
const HSC_SCIENCE_SUBJECTS = [
  {
    id: 1,
    name: "পদার্থবিজ্ঞান",
    description: "Physics এর সম্পূর্ণ HSC পাঠ্যক্রম ও Advanced Concept",
    chapters: 16,
  ...
  },
  {
    id: 2,
    name: "রসায়ন",
    description: "Chemistry এর Advanced ধারণা ও পরীক্ষামূলক সমাধান",
    chapters: 14,
  ...
  },
  {
    id: 3,
    name: "জীববিজ্ঞান",
    description: "Biology এর Advanced টপিক ও HSC নোটস",
    chapters: 18,
  ...
  },
  {
    id: 4,
    name: "উচ্চতর গণিত",
    description: "Advanced Mathematics ও Problem Solving",
    chapters: 20,
  ...
  },
  {
    id: 5,
    name: "ICT",
    description: "Information and Communication Technology এর মৌলিক ধারণা",
    chapters: 10,
      ...
      <div className="p-6 md:p-8 max-w-lg mx-auto">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 text-sm md:text-base">
            HSC Science এর সম্পূর্ণ পাঠ্যক্রম পেতে এখনই ডাউনলোড করুন। আমাদের অ্যাপ শীঘ্রই আসছে!
          </p>
        </div>
  ...
  <div className={`bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-gray-100`}>
    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-4">
        <span className="px-2 py-1 bg-blue-50 text-blue-600 text-xs font-medium rounded">HSC Science</span>
      </div>
      <button 
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">
            HSC <span className="text-blue-600">Science</span> Program
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            HSC Science এর Advanced পাঠ্যক্রম, নোটস এবং মডেল টেস্ট সহ প্রস্তুতি নিন সেরা ফলাফলের জন্য।
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {HSC_SCIENCE_SUBJECTS.map(subject => (
        ...
        <div className="text-center bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-12 text-white">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            HSC Science এর সম্পূর্ণ পাঠ্যক্রম, নোটস এবং মডেল টেস্ট পেতে এখনই Exam Hero অ্যাপ ডাউনলোড করুন
          </p>
          <button 
